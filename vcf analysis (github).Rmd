...
all_arms_label <- c("Thailand Parent", "Hong Kong Parent", "Singapore Parent", "Thailand Senior", "Hong Kong Senior")
...
hk_p_1 <- hk_p_1 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_p_1$ï..user_id <- format(hk_p_1$ï..user_id, scientific = F)
hk_p_2 <- hk_p_2 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_p_2$ï..user_id <- format(hk_p_2$ï..user_id, scientific = F)
hk_p_3 <- hk_p_3 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_p_3$ï..user_id <- format(hk_p_3$ï..user_id, scientific = F)
hk_p_4 <- hk_p_4 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_p_4$ï..user_id <- format(hk_p_4$ï..user_id, scientific = F)

hk_s_1 <- hk_s_1 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_s_1$ï..user_id <- format(hk_s_1$ï..user_id, scientific = F)
hk_s_2 <- hk_s_2 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_s_2$ï..user_id <- format(hk_s_2$ï..user_id, scientific = F)
hk_s_3 <- hk_s_3 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_s_3$ï..user_id <- format(hk_s_3$ï..user_id, scientific = F)
hk_s_4 <- hk_s_4 %>% dplyr::select(ï..user_id, wa_id_parsed)
hk_s_4$ï..user_id <- format(hk_s_4$ï..user_id, scientific = F)

th_p_1 <- th_p_1 %>% dplyr::select(ï..user_id, wa_id_parsed)
th_p_1$ï..user_id <- format(th_p_1$ï..user_id, scientific = F)
th_p_2 <- th_p_2 %>% dplyr::select(ï..user_id, wa_id_parsed)
th_p_2$ï..user_id <- format(th_p_2$ï..user_id, scientific = F)

th_s_1 <- th_s_1 %>% dplyr::select(ï..user_id, wa_id_parsed)
th_s_1$ï..user_id <- format(th_s_1$ï..user_id, scientific = F)
th_s_2 <- th_s_2 %>% dplyr::select(ï..user_id, wa_id_parsed)
th_s_2$ï..user_id <- format(th_s_2$ï..user_id, scientific = F)

sg_p_1 <- sg_p_1 %>% dplyr::select(ï..user_id, wa_id_parsed)
sg_p_1$ï..user_id <- format(sg_p_1$ï..user_id, scientific = F)
sg_p_2 <- sg_p_2 %>% dplyr::select(ï..user_id, wa_id_parsed)
sg_p_2$ï..user_id <- format(sg_p_2$ï..user_id, scientific = F)
sg_p_3 <- sg_p_3 %>% dplyr::select(ï..user_id, wa_id_parsed)
sg_p_3$ï..user_id <- format(sg_p_3$ï..user_id, scientific = F)
sg_p_4 <- sg_p_4 %>% dplyr::select(ï..user_id, wa_id_parsed)
sg_p_4$ï..user_id <- format(sg_p_4$ï..user_id, scientific = F)
